...
export default function HowToPlay() {
  return (
    <div className="min-h-screen pb-20">
      <nav className="sticky top-0 z-50 border-b border-border/50 bg-surface/70 backdrop-blur-xl">
      ...
      <div className="max-w-2xl mx-auto px-4 py-8 space-y-6">
        <div className="text-center">
          ...
          <p className="font-mono tracking-wider mt-2">Como jugar</p>
        </div>
        <motion.div
        ...
        <RuleSection title="Resumen Rápido">
          <div className="grid grid-cols-2 gap-3">
            <QuickCard title="Hit" desc="Recibe otra carta" color="primary" />
            <QuickCard title="Stay" desc="Guarda tus puntos" color="success" />
            <QuickCard
              title="Bust"
              desc="0 puntos para la ronda"
              color="danger"
            />
            <QuickCard title="Flip 7" desc="+15 puntos bonus" color="gold" />
          </div>
        </RuleSection>

        <RuleSection title="El Mazo">
        ...
        <RuleSection title="Cartas de Acción">
          ...
          <div className="space-y-3">
            ...
            <ActionCard
              ...
              effect={<>Se detén temprano si logra Flip 7 o si hace bust.</>}
            />
            <ActionCard
              name="Second Chance!"
              desc="Conservala. Si sacas un duplicado, descártala junto al duplicado."
              effect={<>¡Te salva del bust! Solo puedes tener una a la vez.</>}
            />
          </div>
        </RuleSection>

        <RuleSection title="Cartas Modificadoras">
          <p className="text-sm text-muted">
        ...
        <RuleSection title="Fin de Ronda">
